            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Seleccione un usuario para ingresar una solicitud de tiempo extra
                            </p>
                        </div>
                ...
                @if($elementos->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500 dark:text-gray-400">No se encontraron empleados para registrar tiempos extras.</p>
                    </div>
                @else
                        ...
                        @foreach($elementos as $elemento)
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-200 hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-700">
                                <div class="p-5">
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('sup.tiemposExtrasForm', $elemento->id) }}"
