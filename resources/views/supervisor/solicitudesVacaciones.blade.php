            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Gestione las solicitudes de vacaciones de los empleados
                            </p>
                        </div>
                ...
                @if($solicitudes->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No hay solicitudes registradas</h3>
                        <p class="text-gray-500 dark:text-gray-400 mb-6">No se encontraron solicitudes de vacaciones.</p>
                ...
                @else
                    ...
                    <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="text-sm font-medium text-blue-800 dark:text-blue-200">Nota importante</h4>
                                <p class="text-sm text-blue-700 dark:text-blue-300 mt-1">
                                    Al aceptar una solicitud, se deberá descargar el archivo PDF con el formato de solicitud de vacaciones, el cual deberá ser firmado por el elemento, para después ser subido nuevamente al sistema y que la solicitud sea aceptada correctamente.
                                </p>
                            </div>
                        </div>
                    </div>
