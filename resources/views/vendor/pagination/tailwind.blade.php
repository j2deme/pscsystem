        ...
        <div>
            <span class="relative z-0 inline-flex rounded-md shadow-sm rtl:flex-row-reverse">
                ...
                <span aria-current="page">
                    <span
                        class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-bold leading-5 text-blue-600 bg-white border border-blue-500 cursor-default dark:bg-gray-800 dark:border-blue-700 dark:text-blue-400">{{
                        $page }}</span>
                </span>
                @else
