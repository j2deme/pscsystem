            ...
            <h2 class="text-2xl mb-4">Formulario de Solicitud de Baja</h2>
                <div class="overflow-x-auto bg-white rounded-lg shadow">
                    @if($solicitudpendiente)
                        <p>
                            No puede realizar más acciones por el momento, ya que aún tiene una solicitud pendiente. Favor de esperar la respuesta a su solicitud
                        </p>
                    ...
                    @else
                    <form action="{{route('user.registrarSolicitudBaja', $user->id)}}" method="POST" class="space-y-6">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="por" id="por" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                        ...
                                        <option value="Separación Voluntaria">Renuncia</option>
                                    </select>
                                </div>
                                <div>
