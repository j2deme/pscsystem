            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Consulte el historial completo de solicitudes de vacaciones
                            </p>
                        </div>

                        <div class="flex items-center space-x-2">
                            <div class="bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 px-3 py-1 rounded-full">
                                <span class="text-sm font-medium">{{ $vacaciones->total() }}</span>
                ...
                @if($vacaciones->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500 dark:text-gray-400">No se han registrado vacaciones.</p>
                    </div>
                @else
                                    ...
                                    @foreach($vacaciones as $vacacion)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                                {{ \Carbon\Carbon::parse($vacacion->created_at)->format('d/m/Y') }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @php
                                                    $statusConfig = match($vacacion->estatus) {
                    ...
                    @if($vacaciones->hasPages())
                        <div class="mt-6 flex items-center justify-between">
                            <div class="text-sm text-gray-700 dark:text-gray-300">
                                Mostrando
                                <span class="font-medium">{{ $vacaciones->firstItem() }}</span>
                                a
                                <span class="font-medium">{{ $vacaciones->lastItem() }}</span>
                                de
                                <span class="font-medium">{{ $vacaciones->total() }}</span>
                                registros
                            </div>
