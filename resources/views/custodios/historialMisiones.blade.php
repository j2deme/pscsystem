            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Listado completo de misiones registradas
                            </p>
                        </div>
                ...
                @if ($misiones->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No hay misiones registradas</h3>
                        <p class="text-gray-500 dark:text-gray-400">Actualmente no hay misiones registradas en el sistema.</p>
                    </div>
                @else
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="px-6 py-12 text-center">
                                                ...
                                                <p class="text-gray-500 dark:text-gray-400">No hay misiones registradas.</p>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
                    ...
                    @if($misiones->hasPages())
                        <div class="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div class="flex items-center space-x-1">
                                ...
                                @else
                                    <a href="{{ $misiones->previousPageUrl() }}" class="px-3 py-1 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 rounded hover:bg-gray-100 dark:hover:bg-gray-700">&laquo;</a>
                                @endif
                                ...
                                @foreach ($misiones->links()->elements[0] as $page => $url)
                                    ...
                                    @else
                                        <a href="{{ $url }}" class="px-3 py-1 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 rounded hover:bg-gray-100 dark:hover:bg-gray-700">{{ $page }}</a>
                                    @endif
                                @endforeach

                                @if ($misiones->hasMorePages())
                                    <a href="{{ $misiones->nextPageUrl() }}" class="px-3 py-1 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 rounded hover:bg-gray-100 dark:hover:bg-gray-700">&raquo;</a>
                                @else
