            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Listado de misiones actualmente activas
                            </p>
                        </div>
                        ...
                        @if(isset($misiones) && $misiones->isNotEmpty())
                            <div class="flex items-center space-x-2">
                                <div class="bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 px-3 py-1 rounded-full">
                                    <span class="text-sm font-medium">{{ $misiones->count() }}</span>
                ...
                @if ($misiones->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No hay misiones en curso</h3>
                        <p class="text-gray-500 dark:text-gray-400">Actualmente no hay misiones activas registradas en el sistema.</p>
                    </div>
                @else
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="px-6 py-12 text-center">
                                                ...
                                                <p class="text-gray-500 dark:text-gray-400">No hay misiones en curso actualmente.</p>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
