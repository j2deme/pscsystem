            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Consulte y gestione las bajas recientes de empleados
                            </p>
                        </div>
                ...
                @if($bajas->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">No hay bajas recientes</h3>
                        <p class="text-gray-500 dark:text-gray-400">No se encontraron bajas recientes de empleados.</p>
                    </div>
                @else
