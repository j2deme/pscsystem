...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Busque y genere riesgos de trabajo para los empleados
                </p>
            </div>
    ...
    @if($users->isEmpty())
        <div class="text-center py-12">
            ...
            <p class="text-gray-500 dark:text-gray-400 mb-6">No se encontraron empleados que coincidan con su búsqueda.</p>
        </div>
    @else
                        ...
                        @foreach ($users as $user)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @else
                                        <span class="text-gray-400 dark:text-gray-500 text-sm">N/D</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if ($user->rol == 'admin')
                                    ...
                                    <div class="flex items-center justify-center space-x-2">
                                        <a href="{{ route('aux.generarIncapacidadForm', $user->id) }}"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20h18a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            </svg>
                                        </a>

                                        @if($user->solicitudAlta)
                                            <a href="{{ route('rh.detalleSolicitud', $user->solicitudAlta->id) }}"
                                               class="inline-flex items-center justify-center p-2 rounded-lg bg-gray-600 hover:bg-gray-700 text-white transition duration-200 shadow-sm"
                                               title="Ver detalles">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
