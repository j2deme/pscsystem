...
<div class="py-6 mx-auto">
    ...
    ['icon' => 'ti-eye', 'label' => 'Detalle Servicio']
                ...
                <div class="space-y-2 text-gray-700 dark:text-gray-200">
                    ...
                    <dl class="space-y-1">
                        ...
                        <div>
                            ...
                            <dd class="inline ml-1">{{ \Carbon\Carbon::parse($servicio->fecha)->format('d/m/Y') }}</dd>
                        </div>
        ...
        $serviciosUnidad = \App\Models\Servicio::where('unidad_id', $servicio->unidad_id)
        ->orderBy('fecha', 'asc')->get();
        $indexActual = $serviciosUnidad->search(fn($s) => $s->id == $servicio->id);
        $servicioPrevio = $indexActual > 0 ? $serviciosUnidad[$indexActual - 1] : null;
        $servicioSiguiente = ($indexActual !== false && $indexActual < $serviciosUnidad->count() - 1) ?
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full items-stretch">
                            ...
                            <div
                                ...
                                <div class="flex flex-col items-center mb-2 w-full relative">
                                    ...
                                    <div
                                        ...
                                        {{ \Carbon\Carbon::parse($servicioSiguiente->fecha)->format('d/m/Y') }}
                                    </div>
                                    <div
                        ...
                        <div class="flex flex-col items-center w-full">
                            <div
                                ...
                                <div class="flex w-full justify-end items-center mb-1">
                                    <span
                                        class="flex items-center gap-1 text-blue-700 dark:text-blue-300 text-sm font-bold">
                                        <i class="ti ti-calendar"></i>
                        ...
                        <div class="flex flex-col items-center w-full">
                            ...
                            <div
                                ...
                                <div class="flex flex-col items-center mb-2 w-full relative">
                                    <div
                                        class="absolute top-0 left-0 flex items-center gap-1 text-blue-600 dark:text-blue-300 text-xs font-semibold">
                                        <i class="ti ti-calendar"></i>
                                        {{ \Carbon\Carbon::parse($servicioPrevio->fecha)->format('d/m/Y') }}
                                    </div>
                                    <div
